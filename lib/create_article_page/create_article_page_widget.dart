...
class CreateArticlePageWidget extends StatefulWidget {
  ...
  static String routeName = 'CreateArticlePage';
  static String routePath = '/createArticlePage';
...
class _CreateArticlePageWidgetState extends State<CreateArticlePageWidget> {
  ...
  void initState() {
    ...
    _model.summarizeTextController ??= TextEditingController();
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: _model.summarizeTextController,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await CommunityArticleRecord.collection
                                      .doc()
                                      .set({
                                    ...createCommunityArticleRecordData(
                                      ...
                                      summarize:
                                          _model.summarizeTextController.text,
                                    ),
                                    ...mapToFirestore(
                                      {
                                        'createdAt':
