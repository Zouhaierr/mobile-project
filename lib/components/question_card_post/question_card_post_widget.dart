...
import 'question_card_post_model.dart';
export 'question_card_post_model.dart';

class QuestionCardPostWidget extends StatefulWidget {
  const QuestionCardPostWidget({
    super.key,
    String? author,
    String? avatar_id,
    String? body,
  ...
  @override
  State<QuestionCardPostWidget> createState() => _QuestionCardPostWidgetState();
}

class _QuestionCardPostWidgetState extends State<QuestionCardPostWidget> {
  late QuestionCardPostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuestionCardPostModel());
  }
        ...
        child: Container(
          ...
          child: StreamBuilder<List<CommunityQuestionRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<CommunityQuestionRecord> columnCommunityQuestionRecordList =
                  snapshot.data!;
