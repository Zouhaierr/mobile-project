...
/// view.
///
/// At the top, include a large bold Title and an 'X' icon to close. Below
/// that, add a Dropdown Menu labeled 'Current Status' with options: Backlog,
/// To Do, In Progress, Done. Add a multi-line Textfield for the task
