...
class EventCardWidget extends StatefulWidget {
  const EventCardWidget({
    ...
    String? title,
    bool? is_online,
  })  : this.attendees = attendees ?? '12',
        this.avatars = avatars ??
            'https://i.pravatar.cc/150?u=1,https://i.pravatar.cc/150?u=2',
        this.date = date ?? 'Oct 24',
        this.subject = subject ?? 'Mathematics',
        this.time = time ?? '2:00 PM',
        this.title = title ?? 'Advanced Calculus: Integration Techniques',
        this.is_online = is_online ?? true;
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      if (widget.is_online ? true : false)
                                        Icon(
                                      ...
                                      if (widget.is_online ? false : true)
                                        Icon(
                                ...
                                Text(
                                  widget.is_online ? 'Online' : 'In-Person',
                                  style: FlutterFlowTheme.of(context)
                                      .labelSmall
                                      .override(
                                        font: GoogleFonts.plusJakartaSans(
